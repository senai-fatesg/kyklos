...
<body>
   ...
   <div class="loginRight">
      <form action="j_spring_security_check" method="post">
         ...
         <font class="loginText">USUÁRIO</font><br /> <input class="loginBars" type="text" id="usuario" name="j_username" class="span3" /><br />
         <font class="loginText">SENHA</font><br />
         <input class="loginBars" type="password" name="j_password" class="span3" /><br />
         <br /> <input class="loginButton" type="submit" value="Entrar" /><br />
         <br />
      </form>
