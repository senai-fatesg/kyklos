...
import br.com.ambientinformatica.kyklos.persistencia.CorDao;
...
public class ProdutoControl {
	...
	public void editar() {
		try {
			...
			if (!produtoConsultado.getDescricao().equals(produto.getDescricao()) || !produtoConsultado.getUnidadeMedida().equals(produto.getUnidadeMedida()) || produtoConsultado.isBemDeConsumo() != produto.isBemDeConsumo()) {
	...
	public List<UnidadeMedida> completeUnidadeDeMedida(String siglaOuDescricao) {
		return unidadeMedidaDao.consultarPorSiglaOuDescricao(siglaOuDescricao);
	}
	...
	public List<Cor> completeCores(String codigoDescricao) {
	   return corDao.listarCores(codigoDescricao);
	}
